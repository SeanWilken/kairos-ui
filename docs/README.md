...
Studio screenshots can be used in docs for visual reference. Add them under `docs/images/` and keep filenames stable so links remain valid.

- [Images guide](./images/README.md)
